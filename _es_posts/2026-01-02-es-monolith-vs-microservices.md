...
tags: [monolito, microservicios, architecture, decisiones]
author: "Alberto Ruiz"
excerpt: 'En casi todas las conversaciones sobre architecture aparece la misma pregunta: "¿Monolito o microservicios?"'
---

En casi todas las conversaciones sobre architecture aparece la misma pregunta: “¿Monolito o microservicios?”. La forma en que se plantea ya contiene el error.
...
En la práctica, sin embargo, la mayoría de las organizaciones no fracasan por haber elegido mal una architecture. Fracasan por no entender **qué implica realmente** la architecture que adoptan.
...
No existe una architecture moderna. Existe una architecture **adecuada para un contexto concreto**. El trabajo del arquitecto no es elegir entre monolito o microservicios, sino decidir **cuánta complejidad puede absorber una organización sin romperse**.
